...
function calculateTotal() {
    ...
    if (x <= rows[0].cells[5].innerText) {
        document.getElementById('_alltotal').innerText = '補助使用額度：' + Math.floor(x);
        ...
        document.getElementById('_alltotal').innerText = '補助使用額度：' + rows[0].cells[5].innerText +'(**額度已滿**)';
...
function GcalculateTotal() {
    ...
    if (x <= rows[0].cells[5].innerText) {
        document.getElementById('g_alltotal').innerText = '補助使用額度：' + Math.floor(x);
        ...
        document.getElementById('g_alltotal').innerText = '補助使用額度：' + rows[0].cells[5].innerText +'(**額度已滿**)';
        //全部金額-補助額=全自費額   裡面有16%已經算了，剩下84%
        var y = x - parseInt(rows[0].cells[5].innerText);
        var z = y * (1 - parseFloat(rows[2].cells[3].innerText));
